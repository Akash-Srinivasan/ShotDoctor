 ...
 * Allows users to modify their profile preferences
...
export default function EditPreferencesScreen() {
  ...
  useEffect(() => {
    if (profile) {
      ...
      setShootingHand(profile.shooting_hand || 'right');
      ...
      setPreferredDistance(profile.preferred_distance || null);
      setPlaysOrganized(profile.plays_organized || false);
      setPracticeFrequency(profile.practice_frequency || null);
    }
  }, [profile]);
      ...
      >
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={handleCancel} style={styles.backButton}>
            <Ionicons name="chevron-back" size={28} color="#FF4D00" />
          </TouchableOpacity>
